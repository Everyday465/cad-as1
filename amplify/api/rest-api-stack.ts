...
export class RestApiAwsStack extends Stack {
    ...
    const dbTable = new Table(this, 'dbTable-lostnfound', {
    ...
    const api = new RestApi(this, 'restAPI-lostnfound', {
        restApiName: 'restAPI-lostnfound',
    ...
    const usagePlan = new UsagePlan(this, 'usage-plan-lostnfound', {
        name: 'usage-plan-lostnfound',
        apiStages: [
          {
            api,
